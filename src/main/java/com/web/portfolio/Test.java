...
public class Test {
    ...
    public static void init() {
        ...
        TStock ts4 = new TStock("2610.TW", "華航", classify1);

        TStock ts5 = new TStock("USDTWD=x", "美金台幣", classify2);
        TStock ts6 = new TStock("JPYTWD=x", "日幣台幣", classify2);
        TStock ts7 = new TStock("CNYTWD=x", "人民幣台幣", classify2);
        
        TStock ts8 = new TStock("^TWII", "台灣加權", classify3);
        TStock ts9 = new TStock("^IXIC", "納斯達克", classify3);
        TStock ts10 = new TStock("^DJI", "道瓊工業", classify3);
